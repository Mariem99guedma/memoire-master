...
public class KafkaProducer {
    ...
    public <K extends KafkaTransferable> void sendMessage(K message) throws JsonProcessingException {
        ...
        ProducerRecord<Object, Object> record = new ProducerRecord<Object, Object>(TOPIC,
                mapper.writeValueAsString(message));

        record.headers().add(HeaderKeys.HEADER_MESSAGE_TYPE, message.getClass().getSimpleName().getBytes());
        record.headers().add(HeaderKeys.HEADER_MESSAGE_KEY, id.getBytes());
